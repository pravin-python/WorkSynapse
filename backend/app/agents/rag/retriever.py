...
from app.agents.rag.vectorstore.chroma_store import ChromaVectorStore # Default to Chroma for now
...
class Retriever:
    ...
    def __init__(self):
        ...
        if self.vector_store_type == "pgvector":
            ...
            from app.agents.rag.vectorstore.chroma_store import ChromaVectorStore
