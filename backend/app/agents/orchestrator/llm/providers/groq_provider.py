...
Groq integration using standard OpenAI compatibility.
"""
...
class GroqProvider(BaseLLMProvider):
    """
    Groq LLM provider using LangChain's ChatOpenAI with Groq base URL.

    Supports Llama3, Mixtral, and Gemma models on Groq's LPU.
    """

    def _create_client(self) -> BaseChatModel:
        """Create the ChatOpenAI client configured for Groq."""
